...
export class CoinDetailComponent implements OnInit {
  ...
  constructor(private apiService:ApiServiceService,private activatedroute:ActivatedRoute,private currencyService:CurrencyService) {
  ...
  getGraphData(days:number){
    this.days = days
    this.apiService.getGrpahicalCurrencyData(this.coinId,this.currency,this.days)
    .subscribe(res=>{      
      setTimeout(() => {
